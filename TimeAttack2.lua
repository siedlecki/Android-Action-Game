...
local function move(event)
    ...
    local function gameOver()
        ...
        composer.setVariable("fwynikTA2", score)   --przesłanie wyniku
        composer.removeScene("TimeAttack2")  --usunięcie sceny by zwolnić pamięć
        composer.gotoScene( "HighScoreTA2", "fade", 500 )  --przejście do sceny wyników
    end
...
local function newgameTouched (event)
    ...
    composer.removeScene("TimeAttack2")
...
local function addNewObject()
    ...
    elseif(a>25 and a<=45)then --losowanie gry zlej żelki
    ...
    elseif(a>48 and a<=51)then --tworzenie obiektu powerJelly
            ...
            local b=math.random(1,5) --losowanie koloru jelly
            if (b==1) then
                g="jelly-blue.png"
            elseif(b==2)then
                g="jelly-green.png"
