...
--używam bibloteki Json do zapisywania wyników do plików
 ...
 local sciezka = system.pathForFile("ScoreTA2.json", system.DocumentsDirectory)
...
local function gotoMenu()
    ...
    composer.removeScene("HighScoreTA2") --usunięcie sceny by zwolnić pamięć i przejście do następnej
    composer.setVariable("fwynikTA2", 0) --wyzerowanie zmiennej wyniku by wpisywać tej samej wartości przy wielokrotnym wejściu do HighScore
...
local function restart()
    ...
    composer.removeScene("HighScoreTA2")
...
function scene:create( event )
    ...
    wczytajWyniki()
    table.insert(tabelaWynikow, composer.getVariable("fwynikTA2"))
    ...
    local HighScoreHeader = display.newText(sceneGroup, "High Scores Time Attack2", display.contentCenterX, 10, nil, 25)
