...
--używam bibloteki Json do zapisywania wyników do plików
 ...
 local sciezka = system.pathForFile("ScoreJP2.json", system.DocumentsDirectory)
...
local function gotoMenu()
    ...
    composer.removeScene("HighScoreJPMedium")  --usunięcie sceny by zwolnić pamięć i przejście do następnej
    composer.setVariable("fwynikP2", 0) --wyzerowanie zmiennej wyniku by wpisywać tej samej wartości przy wielokrotnym wejściu do HighScore
...
local function restart()
    ...
    composer.removeScene("HighScoreJPMedium")
...
function scene:create( event )
    ...
    wczytajWyniki()
    table.insert(tabelaWynikow, composer.getVariable("fwynikP2"))
    ...
    local HighScoreHeader = display.newText(sceneGroup, "High Scores Jelly Picker[Medium]", display.contentCenterX, 10, nil, 25)
