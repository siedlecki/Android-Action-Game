...
function scene:create( event )
    ...
    -- tworzenie zdarzenia odpowiedzalnego za pojawianie sie objektów
    ...
    local function gameOver()
        ...
        composer.setVariable("fwynikC2", score) --przesłanie wyniku
        composer.removeScene("JellyCatcherMedium") --usunięcie sceny by zwolnić pamięć
        composer.gotoScene( "HighScoreJCMedium", "fade", 500 )  --przejście do sceny wyników
    end
    ...
    local function newgameTouched (event)
        ...
        composer.removeScene("JellyCatcherMedium")
...
local function onCollision(self,event)
    if ( event.phase == "began" ) then
        if(event.target.type=="jar")then --sprawdzamy jakie obiekty kolidują z sobą
            ...
            if(event.other.type=="jelly")then --jeżeli żelka to dodajmy do wyniku 1 x mnożnik          
            ...
            elseif(event.other.type=="powerjelly")then --zwiększamy mnożnik
...
licznik2=timer.performWithDelay(20000,   function()
