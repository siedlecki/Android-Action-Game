...
-- -----------------------------------------------------------------------------------
 ...
 local sciezka = system.pathForFile("ScoreJellyPicker.json", system.DocumentsDirectory)
...
local function gotoMenu()
    ...
    composer.removeScene("HighScoreJellyPicker")   --usunięcie sceny by zwolnić pamięć i przejście do następnej
    composer.setVariable("fwynik3", 0) --wyzerowanie zmiennej wyniku by wpisywać tej samej wartości przy wielokrotnym wejściu do HighScore
...
local function restart()
    ...
    composer.removeScene("HighScoreJellyPicker")
...
function scene:create( event )
    ...
    wczytajWyniki()
    table.insert(tabelaWynikow, composer.getVariable("fwynik3"))
    ...
    local HighScoreHeader = display.newText(sceneGroup, "High Scores Jelly Picker[Hard]", display.contentCenterX, 10, nil, 25)
