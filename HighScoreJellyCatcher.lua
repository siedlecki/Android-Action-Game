...
-- -----------------------------------------------------------------------------------
 ...
 local sciezka = system.pathForFile("ScoreJCHard.json", system.DocumentsDirectory)
...
local function gotoMenu()
    ...
    composer.removeScene("HighScoreJellyCatcher")  --usunięcie sceny by zwolnić pamięć i przejście do następnej
    composer.setVariable("fwynikC3", 0) --wyzerowanie zmiennej wyniku by wpisywać tej samej wartości przy wielokrotnym wejściu do HighScore
...
local function restart()
    ...
    composer.removeScene("HighScoreJellyCatcher")
...
function scene:create( event )
    ...
    wczytajWyniki()
    table.insert(tabelaWynikow, composer.getVariable("fwynikC3"))
    ...
    local HighScoreHeader = display.newText(sceneGroup, "High Scores Jelly Catcher[Hard]", display.contentCenterX, 10, nil, 25)
