...
function scene:create( event )
    ...
    local function gameOver()
        ...
        composer.setVariable("fwynikC1", score) --przesłanie wyniku
        composer.removeScene("JellyCatcherEasy") --usunięcie sceny by zwolnić pamięć
        composer.gotoScene( "HighScoreJCEasy", "fade", 500 )  --przejście do sceny wyników
    end
    ...
    local function newgameTouched (event)
        ...
        composer.removeScene("JellyCatcherEasy")
...
licznik2=timer.performWithDelay(30000,   function() 
