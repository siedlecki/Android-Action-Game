...
function scene:create( event )
    ...
    local function gameOver()
        ...
        composer.setVariable("fwynikP2", score) --przesłanie wyniku
        composer.removeScene("JellyPickerMedium") --usunięcie sceny by zwolnić pamięć
        composer.gotoScene( "HighScoreJPMedium", "fade", 500 )  --przejście do sceny wyników
    end
    ...
    local function newgameTouched (event)
        ...
        lineGroup:removeSelf()
        physics.stop()
        composer.setVariable("fwynikP2", 0)
        composer.removeScene("JellyPickerMedium")
...
local function jarTouched(event)
    ...
    if(gamestate=="paused")then
        ...
        if(event.phase=="began")then
            ...
            if (live<3) then --sprawdzenie warunku i zwiększenie życia
                live=live+1
                liveText.text=live
            else  
                score=score+2
            ...
            if(event.target.type=="jared")then  --zwolnienie pozycji
        ...
        local b=math.random(1,5) --losujemy kolor jar
            ...
            elseif(c==3)then
                if(PositionCCheck==false)then
                    ...
                    if(time%20==0)then  --zmieniamy prędkość pojawiania się jar zależnie od czasu
						timeForJar2=timeForJar2-1000
    					if(timeForJar2==1000)then
    						timeForJar2=1000
    					end
					end
        ...
        local d=math.random(1,100) --losowanie między kamieniem a żelką
            ...
            elseif(d==100)then 
                ...
                if(c==1)then
                    if(JellyPositionA==false)then
                        JellyPositionA=true
                        jelly = display.newImage("jelly-red.png",positionA, display.contentHeight - 420)
                        jelly.type="jelly"
                        ColorTypeJelly="red"
                ...
                elseif(c==2)then
                    if(JellyPositionB==false)then
                        JellyPositionB=true
                        jelly = display.newImage("jelly-blue.png",positionB, display.contentHeight - 420)
                        jelly.type="jelly2"
                        ColorTypeJelly="blue"
                        jelly.type2=ColorTypeJelly
                    else jellycheck=jellycheck-1
                ...
                elseif(c==3)then
                    if(JellyPositionC==false)then
                        JellyPositionC=true
                        jelly = display.newImage("jelly-yellow.png",positionC, display.contentHeight - 420)
                        jelly.type="jelly3"
                ...
                elseif(c==4)then
                    if(JellyPositionD==false)then
                        JellyPositionD=true
                        jelly = display.newImage("jelly-purple.png",positionD, display.contentHeight - 420)
                        jelly.type="jelly4"
